...
import { useMentorDashboard, useMentorDashboardActions, useMentorDashboardData } from '../src/hooks/useMockData';
...
const MentorDashboard: React.FC<MentorDashboardProps> = (props) => {
  ...
  const {
    ...
    null, null, null, null, null, null, // Dummy handlers as they now use mutations internally
    setNotification,

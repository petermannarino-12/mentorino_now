...
const Layout: React.FC<LayoutProps> = ({ children, role }) => {
  ...
  const navItems = [
    { label: 'Home', path: '/', icon: Home, roles: ['user', 'mentor'] },
    { label: 'Dashboard', path: '/dashboard', icon: LayoutDashboard, roles: ['user', 'mentor'] },
    { label: 'Sessions', path: '/dashboard/sessions', icon: Calendar, roles: ['user', 'mentor'] },
    { label: 'Roadmap', path: '/dashboard/roadmap', icon: Activity, roles: ['user'] },
    { label: 'Vault', path: '/dashboard/vault', icon: BookOpen, roles: ['user'] },
    { label: 'Settings', path: '/settings', icon: Settings, roles: ['user', 'mentor'] },
    { label: 'Mentees', path: '/dashboard/mentees', icon: Users, roles: ['mentor'] },
    { label: 'Reviews', path: '/dashboard/reviews', icon: MessageCircle, roles: ['mentor'] },
    { label: 'Networking', path: '/dashboard/events', icon: Sparkles, roles: ['mentor'] },
    { label: 'Networking', path: '/dashboard/networking', icon: Sparkles, roles: ['user'] },
    { label: 'Inquiries', path: '/dashboard/audits', icon: ClipboardList, roles: ['mentor'] },

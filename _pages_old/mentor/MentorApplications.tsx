...
import { Users, X, MapPin, Calendar, Mail, Phone, Target, Zap, Info, ArrowLeft } from 'lucide-react';
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        {pendingApplications.length === 0 && (
          <div className="lg:col-span-3 p-12 sm:p-20 text-center bg-slate-50 rounded-[32px] sm:rounded-[40px] border-2 border-dashed border-slate-200">
             <Users className="mx-auto text-slate-200 mb-4 sm:size-12" size={32} />
             <p className="text-[10px] sm:text-xs font-black uppercase tracking-widest text-slate-400">Perfectly Synchronized — No Leads Pending</p>
          </div>
        )}
      </div>

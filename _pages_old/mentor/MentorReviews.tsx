...
import { CheckCircle, MessageSquare, MoreVertical, ExternalLink, ArrowLeft, ClipboardList } from 'lucide-react';
import { TaskActivity } from '../../src/types';
...
export const MentorReviews: React.FC<MentorReviewsProps> = ({ pendingTasks, onSubmitFeedback }) => {

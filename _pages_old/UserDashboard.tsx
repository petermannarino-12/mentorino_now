...
import { Booking, TaskActivity, NetworkEvent, Announcement, ResourceLink } from '../src/types';
import TaskActivityForm from '../components/TaskActivityForm';
import { formatToNJ } from '../src/lib/dateUtils';
import { useUserDashboardData, useAddTaskMutation, useUpdateTaskStatusMutation, useAttendEventMutation } from '../src/hooks/useMockData';
...
const UserDashboard: React.FC<UserDashboardProps> = ({ 
  ...
  const handleJoinEventSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setNotification(`Strategic request sent for ${joiningEvent.title}. Peter will be notified of your intent.`);
      ...
      <div className="bg-slate-900 p-10 rounded-[48px] text-white space-y-6 shadow-2xl shadow-black/20 relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-4">
          ...
          <p className="text-[11px] font-bold leading-relaxed max-w-[320px] text-white/40 uppercase">
             Submit your professional activities and branding assets for Peter's executive review to align your trajectory.
          </p>
        </div>
      </div>
